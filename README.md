...
[![Crates.io](https://img.shields.io/crates/v/open-agent-sdk.svg?label=open-agent-sdk%200.6.3)](https://crates.io/crates/open-agent-sdk)
...
**Status**: v0.6.3 Published - Security advisories resolved, README example fixes, manual-mode history fixes, multimodal image support, 110+ unit tests, 61 integration tests
