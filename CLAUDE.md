...
- Mutation installer: `taiki-e/install-action` is pinned at v2.87.12. The workflow-policy test asserts the exact SHA and version comment, so update the workflow and assertion together.
